...
async function loadHomeData() {
    ...
    try {
        window.adminSettings = await fsGetSettings();
    } catch(e) {}
...
async function loadHomeTournaments() {
    ...
    try {
        const [tournaments, txs] = await Promise.all([
            fsGetTournaments(),
...
async function submitVote(pollId, optionKey) {
    ...
    try {
        await fsVotePoll(pollId, window.loggedInUserId, optionKey);
